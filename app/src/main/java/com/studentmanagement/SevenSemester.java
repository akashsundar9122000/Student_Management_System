        ...
        imageButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(!"".equals(val1) && !"".equals(val2) && !"".equals(val3) && !"".equals(val4) &&
                        !"".equals(val5) && !"".equals(val6) && !"".equals(val7)) {
                    ...
                    double print = (ans1 + ans2 + ans3 + ans4 + ans5+ ans6+ ans7) / 7.0;
                    String printString = String.format("%.2f", print);
                    Toast.makeText(SevenSemester.this, printString, Toast.LENGTH_LONG).show();
                }
                else {
                    Toast.makeText(SevenSemester.this, "ENTER EVERY SEMESTER GRADES", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
